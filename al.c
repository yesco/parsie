...
// -- object functions
Z';': U=obj(); Z':': S-=2;set(*S,atomize(S[1]),S[2]);
...
//Z'Q': // eQual
Z'S': switch(c=*p++){ Z'A':S--;*S=setcar(*S,S[1]); Z'D':S--;*S=setcdr(*S,S[1]);
Z'a'...'z':VAR=*S--; goto next; default: p--; goto error; }
